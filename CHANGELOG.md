...
## [4.0.0](https://github.com/phanen/fzf-lua-extra/compare/v3.5.0...v4.0.0) (2025-08-16)
...
* bug fixes ([80984eb](https://github.com/phanen/fzf-lua-extra/commit/80984ebec5eb3557b1c849b362bdf26c430227cd))


### Features

* a new action to open file in background ([0b9d69c](https://github.com/phanen/fzf-lua-extra/commit/0b9d69c2c58babf16d8fe9b1c2f720b4599c52ef))
* **action:** ex_run no confirm ([929a98a](https://github.com/phanen/fzf-lua-extra/commit/929a98a4a32a240af75f62075d3bfcf5c9c6a4e4))
* add actions ([5a4872c](https://github.com/phanen/fzf-lua-extra/commit/5a4872c02c613bf0daef9acc656bb332593204ba))
* add icons with extamrk ([8aaa897](https://github.com/phanen/fzf-lua-extra/commit/8aaa897c019524967bda7c3c94415f9ab66bddb1))
* add recentfiles picker ([0bf7165](https://github.com/phanen/fzf-lua-extra/commit/0bf7165601575c780c77c7c97101df4d92855930))
* add rtp picker ([3580913](https://github.com/phanen/fzf-lua-extra/commit/3580913fd9db8a9d54961862ed6c879670df9532))
* add todos in notes query ([777c4fd](https://github.com/phanen/fzf-lua-extra/commit/777c4fda6cefe034ffa425acee8a2fef0a07e737))
* add toggle author actions for lazy.nvim ([41ba5ea](https://github.com/phanen/fzf-lua-extra/commit/41ba5ea15424eace25e0dec9bfa8b7a819a063c2))
* **aerial:** add symbols picker ([230d56c](https://github.com/phanen/fzf-lua-extra/commit/230d56c01f0207acb6f3cd6f2e644552f47ea2c9))
* allow other exts ([23319f9](https://github.com/phanen/fzf-lua-extra/commit/23319f9abd7d95b91db8bf967800f40d56baf74c))
* **builtin:** inject by `extends_builtin` ([6423ad7](https://github.com/phanen/fzf-lua-extra/commit/6423ad7dadc47ef46cc29abd596be72e61bd0fef))
* cache plugin lists ([b1232b2](https://github.com/phanen/fzf-lua-extra/commit/b1232b2c084734d72c8f801cd9d9c51cbe3f3a71))
* cliphist ([fae3e57](https://github.com/phanen/fzf-lua-extra/commit/fae3e57b516a18aa7436c89a3b77732f072b01eb))
* colorful rtp (wip: previewer) ([df66d72](https://github.com/phanen/fzf-lua-extra/commit/df66d723eb47ff441131eaccdcabb960955677c2))
* custom dot_dir ([2a80a11](https://github.com/phanen/fzf-lua-extra/commit/2a80a11e5570f30678b3c80434fc6046cfc0b7b3))
* don't show opened buffers as entry ([270c558](https://github.com/phanen/fzf-lua-extra/commit/270c558a0d1e74f60771fa8f5f90bba92622b9be))
* **function:** init ([98917fa](https://github.com/phanen/fzf-lua-extra/commit/98917fa27320075ab2309a7cdda20591310357d1))
* gitignore picker ([a21a9e7](https://github.com/phanen/fzf-lua-extra/commit/a21a9e7165b2df1213c6c6779dedfea506df2ad5))
* **gitlog:** git log -Sx --grep=y ([002df2f](https://github.com/phanen/fzf-lua-extra/commit/002df2f024ec1349e4c1dea71ca6ca144ea0e5d1))
...
* init config ([6c43699](https://github.com/phanen/fzf-lua-extra/commit/6c43699e1bdd5416c26d3bb2afc0186bde8b2946))
* inject default-title style ([8197f62](https://github.com/phanen/fzf-lua-extra/commit/8197f62071b8c21ada17455a751e96b7b9041075))
* license picker ([edf4c10](https://github.com/phanen/fzf-lua-extra/commit/edf4c10ac84093f0689ffeab93a3ef39cbce5fd8))
* ls, bcommits ([d2e47b3](https://github.com/phanen/fzf-lua-extra/commit/d2e47b396bfccd3e2b3618adca915dc84982804d))
...
* make opts optional ([5e57a41](https://github.com/phanen/fzf-lua-extra/commit/5e57a4138889b96603c0e22e66d25c4e88f71d51))
* mimic builtin ([1bcc93d](https://github.com/phanen/fzf-lua-extra/commit/1bcc93dfb7bae776f8f6804e12c94ef766f04122))
* multiple dirs ([c75d1f3](https://github.com/phanen/fzf-lua-extra/commit/c75d1f353f58ed0f23ecd68a5128e4830743773b))
...
* optional commands ([f76b6f5](https://github.com/phanen/fzf-lua-extra/commit/f76b6f583133876a7bb13f88eba4596f79f4206c))
* passthrough opts ([a9e0656](https://github.com/phanen/fzf-lua-extra/commit/a9e0656a58c23c53b21c3b735930e2d6804f5f91))
* picker for scriptnames ([9d7f842](https://github.com/phanen/fzf-lua-extra/commit/9d7f842e4c28c2b8c6464cd57f06e6cd93ddbafc))
* **plocate:** init ([1e9650a](https://github.com/phanen/fzf-lua-extra/commit/1e9650a76bce51315b2be9eb0979bab86eeefdfc))
* plugins do ([9383e8d](https://github.com/phanen/fzf-lua-extra/commit/9383e8d6b3c789e922990bb08e34f6ec31373e7e))
* prefer buf's root for `git*` picker ([84e2260](https://github.com/phanen/fzf-lua-extra/commit/84e226012903e154390e5adfdd0ed7c3ca0c453f))
* preview dirent ([8a7d2e3](https://github.com/phanen/fzf-lua-extra/commit/8a7d2e3d84d9e341beb06a703944b35fa37df8b8))
...
* reload plugins ([764eb7d](https://github.com/phanen/fzf-lua-extra/commit/764eb7d6ddb119ae1413f78e4765c6241a76fc24))
* **runtime:** runtime file ([77c6bc0](https://github.com/phanen/fzf-lua-extra/commit/77c6bc0d6876e5fa75888ec9d326b4743655f32d))
* **scriptnames:** add file icons ([d72fb8d](https://github.com/phanen/fzf-lua-extra/commit/d72fb8d03faf75832606cfa60d1f4a46828c3db9))
* **serverlist:** init ([64bdde1](https://github.com/phanen/fzf-lua-extra/commit/64bdde16aef4b6233b97a23a97dd2d0070689bcf))
* show all plugins and better actions fallback ([c06d639](https://github.com/phanen/fzf-lua-extra/commit/c06d639492adc3a1208063b83e7d8bb9b3285013))
* show README if exist for lazy plugins ([9beb358](https://github.com/phanen/fzf-lua-extra/commit/9beb35861fcc1c566e1acd24da021dceaef0ebb8))
* **swiper:** init ([7e1066d](https://github.com/phanen/fzf-lua-extra/commit/7e1066d7128c8e6ac085aa2fe2c97bf6814f378e))
* todos manager ([6c476e4](https://github.com/phanen/fzf-lua-extra/commit/6c476e48fef78162d5ec8e9738a3d0756da88329))
* toggle between find/grep ([c75d1f3](https://github.com/phanen/fzf-lua-extra/commit/c75d1f353f58ed0f23ecd68a5128e4830743773b))
* use `opt_name` to inhert config from fzf-lua ([64fb0ab](https://github.com/phanen/fzf-lua-extra/commit/64fb0abc780434e42868e9c45a1d4f3ab30bb061))
* use lru for recent closed files ([772a858](https://github.com/phanen/fzf-lua-extra/commit/772a858e364304a60ce47cff0c353e5419febd45))
* use mini.visits ([3a311f5](https://github.com/phanen/fzf-lua-extra/commit/3a311f5ad795289d6187d95d433c4e60d39a22ed))
* use setup opts in fzf_exec ([d8f2d0a](https://github.com/phanen/fzf-lua-extra/commit/d8f2d0a6ed0ff113b8d5170f4e6113c7266e7854))
* vscode-like display for dotfiles ([6383536](https://github.com/phanen/fzf-lua-extra/commit/6383536474db95bcb58f132569940b40164b21c8))
* zoxide delete path ([a3b5a00](https://github.com/phanen/fzf-lua-extra/commit/a3b5a00940424ed636d33d53326adb2a4c5b4b32))


### Bug Fixes

* **aerial:** when id &gt;= 10 ([81a9b1d](https://github.com/phanen/fzf-lua-extra/commit/81a9b1d458ebf8e57c2a1beced9249fd31d63765))
* annoy repeat ([24cfd1d](https://github.com/phanen/fzf-lua-extra/commit/24cfd1ddb4235caeaf46a64985ecce7a4187a478))
* async preview ([d86cf8e](https://github.com/phanen/fzf-lua-extra/commit/d86cf8e877a31683494885b3b402af4a60f81375))
* avoid spam ([469e0f1](https://github.com/phanen/fzf-lua-extra/commit/469e0f1cc4e89171f5fd334d820e937ddbe2a5c9))
* cd to plugins dir ([8a7d2e3](https://github.com/phanen/fzf-lua-extra/commit/8a7d2e3d84d9e341beb06a703944b35fa37df8b8))
* correct inherit ([532effd](https://github.com/phanen/fzf-lua-extra/commit/532effdf24b309306d833e2333ab7b7490f5f30b))
* correct way to get last query ([6c476e4](https://github.com/phanen/fzf-lua-extra/commit/6c476e48fef78162d5ec8e9738a3d0756da88329))
...
* decorate with md syntax ([b3b7869](https://github.com/phanen/fzf-lua-extra/commit/b3b78690f7319b411da82004d139c8c30313c841))
* disable custom global ([b1b3d39](https://github.com/phanen/fzf-lua-extra/commit/b1b3d39a4663b6edc270012bb1d928155ed0ef02))
* disable ui then bulk edit ([8ecd1d5](https://github.com/phanen/fzf-lua-extra/commit/8ecd1d52bc0452dfaf7dc60d1e87a89d0d1090c8))
* don't pass query ([ef2c5ef](https://github.com/phanen/fzf-lua-extra/commit/ef2c5efef92f7219117bd2b1a699782c3999f18f))
* drop hashlist init ([e4970f9](https://github.com/phanen/fzf-lua-extra/commit/e4970f92b763c88bb65e80f8da7a84d12c83d423))
* error path ([cde0f95](https://github.com/phanen/fzf-lua-extra/commit/cde0f95b87f3516189c4485337ea2adaf4f36565))
...
* force create dir ([007e55a](https://github.com/phanen/fzf-lua-extra/commit/007e55acf6cf0ab7679ce057655411c197fd5406))
...
* handle icons in oldfiles ([64fb0ab](https://github.com/phanen/fzf-lua-extra/commit/64fb0abc780434e42868e9c45a1d4f3ab30bb061))
...
* **json:** tbl or str ([7ce78c3](https://github.com/phanen/fzf-lua-extra/commit/7ce78c359e5010438dd29682af9928e1c51dcd8c))
* lazy loading ([71849a9](https://github.com/phanen/fzf-lua-extra/commit/71849a99a8933991c616b3eae6f058665280a62e))
* legacy showcase ([a4419d8](https://github.com/phanen/fzf-lua-extra/commit/a4419d81dfe485157a71e9f600ed86e281902469))
* log on api limited ([105bcdb](https://github.com/phanen/fzf-lua-extra/commit/105bcdbab1d48d5cc1668e7a84663db80e168a3f))
* missing actions ([6b7f108](https://github.com/phanen/fzf-lua-extra/commit/6b7f108abad3dcc91ce101053d12c6d575fdace7))
* missing actions again... ([106fb79](https://github.com/phanen/fzf-lua-extra/commit/106fb799146f0073828776644d748e4ceb15bfd1))
* multiplex ([de221b4](https://github.com/phanen/fzf-lua-extra/commit/de221b48e86027ae81d666b412c54c851fe35daf))
* nil actions ([6c476e4](https://github.com/phanen/fzf-lua-extra/commit/6c476e48fef78162d5ec8e9738a3d0756da88329))
* no fzf-lua deps in utils ([148808a](https://github.com/phanen/fzf-lua-extra/commit/148808ac0bcf8114283109016e162b73ac4f73e1))
* not resume after enter (regression) ([7bcab42](https://github.com/phanen/fzf-lua-extra/commit/7bcab42d273b5e145b48063b1ae5ba3281ac0ace))
* open in browser ([14c545c](https://github.com/phanen/fzf-lua-extra/commit/14c545c565b71fb78982dff36146b7adba789c84))
...
* parse generic url when missing plugin name ([5289af9](https://github.com/phanen/fzf-lua-extra/commit/5289af9afee10de49b09d84b69e00b7f2fb793db))
* passtrough resume query ([309c517](https://github.com/phanen/fzf-lua-extra/commit/309c51757757f428961ea089028d6b54eaed6513))
* path ([6e287fe](https://github.com/phanen/fzf-lua-extra/commit/6e287fe310685ba2de64a83d10b978e678e0f9c5))
* previewer for plugins ([624eb7d](https://github.com/phanen/fzf-lua-extra/commit/624eb7ddd2184686edc6e3a38e634d55ae57fda4))
...
* **recent:** buf/closed/shada ([4a1c757](https://github.com/phanen/fzf-lua-extra/commit/4a1c75785ccc748c60a99b4a1affca476bdcf67e))
* remove nonsense (override by top `prompt = false`) ([94f8f95](https://github.com/phanen/fzf-lua-extra/commit/94f8f952aff42a7e4988b679cf423b715430a0dd))
* remove state file ([53beb83](https://github.com/phanen/fzf-lua-extra/commit/53beb837b9fdcaa187dba2c954a7ede8118d4773))
* revert git buf local opts ([c18aee1](https://github.com/phanen/fzf-lua-extra/commit/c18aee1034ae2a35639a1f8743c017082f5f14ef))
* santinize ([94d97a4](https://github.com/phanen/fzf-lua-extra/commit/94d97a44252a15d440bd9d1c8b323faf9065c5d7))
* shebang ([ee879a9](https://github.com/phanen/fzf-lua-extra/commit/ee879a9a8208914b534155632f5ad2db169b59bf))
* store abs path ([db567dd](https://github.com/phanen/fzf-lua-extra/commit/db567dd82cee72e541a387ae045f098464600854))
* **swiper:** force default flags ([265329c](https://github.com/phanen/fzf-lua-extra/commit/265329c066cfd8003d2acec11f3a1ebe8b4d8cb0))
* typing ([6b4336d](https://github.com/phanen/fzf-lua-extra/commit/6b4336d11b58701912fa99280608b2943a8d5625))
* typo ([5c6bc69](https://github.com/phanen/fzf-lua-extra/commit/5c6bc6997e1788a09f7cda48a9e68c3eaa9a286b))
* typos ([f6dea82](https://github.com/phanen/fzf-lua-extra/commit/f6dea82ed4c3ec742595c19620e105dada64f4a5))
* typos ([9383e8d](https://github.com/phanen/fzf-lua-extra/commit/9383e8d6b3c789e922990bb08e34f6ec31373e7e))
* typos ([c18aee1](https://github.com/phanen/fzf-lua-extra/commit/c18aee1034ae2a35639a1f8743c017082f5f14ef))
...
* when `__recent_hlist` is nil ([e9554d0](https://github.com/phanen/fzf-lua-extra/commit/e9554d0bee07fef35192c5fe04806eeae15cf477))
* when no match ([ef9d906](https://github.com/phanen/fzf-lua-extra/commit/ef9d906e056d7d3f7fb5e287fc69643a69ea6b9b))
* with `ex_run_cr` already ([47a9f23](https://github.com/phanen/fzf-lua-extra/commit/47a9f23c187c0e58e009168193dce49011dae2f2))
* workaroud for some potential circle require ([abceb7f](https://github.com/phanen/fzf-lua-extra/commit/abceb7f393cfe013ae3d0f5b5d8eb7bce434ee95))
* write nil should create file ([08404cd](https://github.com/phanen/fzf-lua-extra/commit/08404cd310d8d022cc775bfc368651a0d0e56fcd))
